...
const s3Events = require('./stackops/s3Events');
...
module.exports = {
	...
	aliasHandleS3Events(currentTemplate, aliasStackTemplates, currentAliasStackTemplate) {
		return s3Events.call(this, currentTemplate, aliasStackTemplates, currentAliasStackTemplate);
	},
	...
	aliasRestructureStack(currentTemplate, aliasStackTemplates, currentAliasStackTemplate) {
		...
		.spread(this.aliasHandleS3Events)
